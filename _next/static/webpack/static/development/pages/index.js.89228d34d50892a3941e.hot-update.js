  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ParticleSystem, [{
    ...
    value: function checkColision(particleA, particleB, mousePosition) {
      ...
      if (mousePosition) {
        ...
        var mousePos = this.p5.createVector(x, y //this.offset.x - x,
        //this.offset.y - y
        );
        distance = realParticlePos.dist(mousePos) / 10;
        console.log("DISTANCE", distance); //console.log("A<<<<", particleA.position, "<<<<COLIDERRR", mousePos);
      } else {
        distance = particleA.position.dist(particleB.position) * 2; //(mousePosition ? 0.5 :
      }
...
//# sourceMappingURL=index.js.89228d34d50892a3941e.hot-update.js.map