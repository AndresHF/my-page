...
var Symbol = /*#__PURE__*/function () {
  function Symbol(p5, positionX) {
    ...
    if (isHead) {
      this.velocity = p5.createVector(0, Math.random() * 1 + 4);
      ...
      if (isHead) {
        ...
        var _loop = function _loop(i) {
          ...
          if (changeSymbol) {
            ...
            setTimeout(function () {
              _this.tail[i].symbol = getRandomSymbol(); //p5.fill(80, 255, 80);
          ...
          if (_this.tail[i].shouldGlow) {
            ...
            p5.fill(80, 255, 80, alpha);
          } // this.shouldGlow ? p5.fill(80, 255, 80) : p5.fill(80, 255, 80, alpha);
...
//# sourceMappingURL=index.js.63ccdc812bd6c6409a2d.hot-update.js.map