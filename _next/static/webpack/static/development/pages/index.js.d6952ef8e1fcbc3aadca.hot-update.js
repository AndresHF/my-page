    ...
    value: function draw(p5) {
      ...
      if (this.tail) {
        for (var i = 0; i < this.tail.length; i++) {
          ...
          var alpha = 255 - 10 * i; //const alphaOffset = this.tail[i].lastSymbol !== this.tail[i].symbol ? alpha + 100: alpha;

          p5.fill(100, 255, 100, alpha);
...
//# sourceMappingURL=index.js.d6952ef8e1fcbc3aadca.hot-update.js.map