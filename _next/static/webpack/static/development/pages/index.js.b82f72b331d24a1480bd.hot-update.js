    ...
    value: function update(p5) {
      ...
      var _loop = function _loop(i) {
        ...
        if (_this.tail[i].shouldGlow) {
          ...
          p5.noStroke();
          p5.fill(_this.tail[i].shadeOffset, 255, _this.tail[i].shadeOffset, _this.tail[i].shadeOffset); //, this.tail[i].shadeOffset
        }
...
//# sourceMappingURL=index.js.b82f72b331d24a1480bd.hot-update.js.map