...
var switchVelocity = function switchVelocity(particleA, particleB, p5, collider) {
  var collisionMultiplier = collider ? 100 : 10;
  particleA.velocity = p5.createVector(particleA.velocity.x * -Math.random() * collisionMultiplier - particleB.velocity.x, particleA.velocity.y * -Math.random() * collisionMultiplier - particleB.velocity.y);
};
...
var ParticleSystem = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ParticleSystem, [{
    ...
    value: function checkColision(particleA, particleB, mousePosition) {
      ...
      if (collided) {
        switchVelocity(particleA, particleB, this.p5, !!this.collider);
...
//# sourceMappingURL=index.js.98525590a6ae40e162fa.hot-update.js.map