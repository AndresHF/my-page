...
var Symbol = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function initSymbol(p5, positionX, isMobile) {
      ...
      this.rainSpeed = isMobile ? getRandomNumber(80, 50) : getRandomNumber(30, 50);
    }
  }, {
    key: "update",
    value: function update(p5) {
      ...
      var changeSymbol = Math.random() > 0.98;

      var _loop = function _loop(i) {
        var calculatedY = _this.position.y - Y_OFFSET * i - 20;
        if (p5.frameCount % 2 == 0) _this.tail[i].shadeOffset -= getRandomNumber(20, 10);
...
//# sourceMappingURL=index.js.0632eb3b96a5b729c2f2.hot-update.js.map