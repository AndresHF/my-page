    ...
    value: function checkColision(particleA, particleB, mousePosition) {
      ...
      if (mousePosition) {
        var x = mousePosition.x,
            y = mousePosition.y;
        distance = particleA.position.dist(this.p5.createVector(x, y)) / 10;
      } else {
        distance = particleA.position.dist(particleB.position) * 2; //(mousePosition ? 0.5 :
      }

      var collided = distance <= particleA.dimension.width;
      console.log("particleB", particleB.position.x, particleB.position.y);
...
//# sourceMappingURL=index.js.e3e949b0980ba074c71c.hot-update.js.map