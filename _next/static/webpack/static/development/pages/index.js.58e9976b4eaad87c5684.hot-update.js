      ...
      if (this.tail) {
        for (var i = 0; i < this.tail.length; i++) {
          ...
          if (checkMouseHover(this.position.x, calculatedY, p5.mouseX, p5.mouseY)) {
            ...
            var alphaOffset = this.tail[i].lastSymbol !== this.tail[i].symbol ? alpha + 50 : alpha;
            p5.fill(0, 150, 0, alphaOffset);
...
//# sourceMappingURL=index.js.58e9976b4eaad87c5684.hot-update.js.map