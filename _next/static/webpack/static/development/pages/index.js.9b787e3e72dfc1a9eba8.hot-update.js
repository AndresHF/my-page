    ...
    value: function checkColision(particleA, particleB, mousePosition) {
      ...
      if (mousePosition) {
        var x = mousePosition.x,
            y = mousePosition.y;
        distance = particleA.position.dist(this.p5.createVector(this.offset.x - x, this.offset.y - y)) / 10;
      } else {
...
//# sourceMappingURL=index.js.9b787e3e72dfc1a9eba8.hot-update.js.map