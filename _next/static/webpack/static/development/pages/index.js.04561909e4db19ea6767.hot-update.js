...
var Particle = /*#__PURE__*/function () {
  function Particle(dimension, p5, offset, color, velocity) {
    ...
    this.accLimit = Math.random();
    this.velLimit = Math.random() + 3;
    this.tail = [];
    this.color = color;
    this.offset = offset;
    this.collided = false;
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Particle, [{
    ...
    value: function update(mouseX, mouseY) {
      ...
      this.acceleration.setMag(this.collided ? -2 : 0.3);
...
//# sourceMappingURL=index.js.04561909e4db19ea6767.hot-update.js.map