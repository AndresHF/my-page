...
var Symbol = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function initSymbol(p5, positionX) {
      ...
      this.shadeOffset = getRandomNumber(255, 80);
      this.rainSpeed = getRandomNumber(70, 10);
    }
  }, {
    key: "update",
    value: function update(p5) {
      ...
      var changeSymbol = Math.random() > 0.999; //Math.random() > 0.95;
      // if (changeSymbol) {
      //   this.symbol = getRandomSymbol();
      // }
      // if (
      ...
      var _loop = function _loop(i) {
        ...
        if (_this.tail[i].shouldGlow) {
          // i < 1 ||
          p5.stroke(200, 255, 200, _this.tail[i].shadeOffset);
          p5.fill(200, 255, 200, _this.tail[i].shadeOffset); //, this.tail[i].shadeOffset * 3
...
//# sourceMappingURL=index.js.101179d8c08b0e479bf7.hot-update.js.map