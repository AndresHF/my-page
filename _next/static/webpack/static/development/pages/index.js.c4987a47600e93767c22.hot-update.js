    ...
    value: function update(p5) {
      ...
      var _loop = function _loop(i) {
        ...
        if (_this.tail[i].shouldGlow) {
          ...
          p5.stroke(brigthness, 255, brigthness, 150, _this.tail[i].shadeOffset); //, this.tail[i].shadeOffset

          p5.fill(0, 255, 0); //, this.tail[i].shadeOffset * 3
...
//# sourceMappingURL=index.js.c4987a47600e93767c22.hot-update.js.map