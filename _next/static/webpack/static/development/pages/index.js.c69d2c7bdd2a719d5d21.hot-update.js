    ...
    value: function draw(p5) {
      ...
      if (this.tail) {
        for (var i = 0; i < this.tail.length; i++) {
          ...
          var alpha = 255 - 5 * i; //const alphaOffset = this.tail[i].lastSymbol !== this.tail[i].symbol ? alpha + 100: alpha;
...
//# sourceMappingURL=index.js.c69d2c7bdd2a719d5d21.hot-update.js.map