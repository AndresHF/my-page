...
var MatrixRainContainer = function MatrixRainContainer(_ref) {
  ...
  var setup = function setup(p5, canvasParentRef) {
    p5.createCanvas(window.innerWidth, window.innerHeight).parent(canvasParentRef); //p5.strokeWeight(10);

    p5.textSize(30);
    var mobileOffset = window.innerWidth < 500 ? 0 : 20;

    for (var i = 0; i < window.innerWidth / 21; i++) {
      //window.innerWidth / 31
...
//# sourceMappingURL=index.js.e558c9b576e123aa4548.hot-update.js.map