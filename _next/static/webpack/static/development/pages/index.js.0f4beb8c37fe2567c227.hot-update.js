...
var Symbol = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function initSymbol(p5, positionX) {
      ...
      this.rainSpeed = 80; //getRandomNumber(70, 50);
    }
  }, {
    key: "update",
    value: function update(p5) {
      ...
      var _loop = function _loop(i) {
        ...
        if (_this.tail[i].shouldGlow) {
          // i < 1 ||
          p5.stroke(255, 255, 255); //, this.tail[i].shadeOffset

          p5.fill(120, 255, 120); //, this.tail[i].shadeOffset * 3

          _this.tail[i].shouldGlow = false;
        } else {
          p5.noStroke();
          p5.fill(255 - _this.tail[i].shadeOffset / 2, 255, 255 - _this.tail[i].shadeOffset / 2, _this.tail[i].shadeOffset); //, this.tail[i].shadeOffset
        }
...
//# sourceMappingURL=index.js.0f4beb8c37fe2567c227.hot-update.js.map