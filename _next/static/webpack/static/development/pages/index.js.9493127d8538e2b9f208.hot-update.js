      ...
      if (this.tail) {
        for (var i = 0; i < this.tail.length; i++) {
          ...
          if (checkMouseHover(this.position.x, calculatedY, p5.mouseX, p5.mouseY)) {
            ...
            var alpha = 255 - 220 / this.tail.length * i; //const alphaOffset = this.tail[i].lastSymbol !== this.tail[i].symbol ? 
...
//# sourceMappingURL=index.js.9493127d8538e2b9f208.hot-update.js.map