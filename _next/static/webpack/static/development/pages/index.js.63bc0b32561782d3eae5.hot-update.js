...
var ParticleSystem = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ParticleSystem, [{
    ...
    value: function setParticles(amount) {
      ...
      console.log("DOIIING THIS", this.particles.length, amount, diff);
      ...
      if (diff > 0) {
        ...
        console.log("THIS PARTICLES", this.particles.slice(0, diff));
      }
    }
  }, {
    key: "checkColision",
...
//# sourceMappingURL=index.js.63bc0b32561782d3eae5.hot-update.js.map