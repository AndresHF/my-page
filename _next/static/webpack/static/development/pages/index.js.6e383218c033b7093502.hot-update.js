...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./src/components/sketchs/background/utils.ts");
...
var ParticleSystem = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ParticleSystem, [{
    ...
    value: function checkColision(particleA, particleB, mousePosition) {
      ...
      if (collided) {
        Object(_utils__WEBPACK_IMPORTED_MODULE_5__["switchVelocity"])(particleA, particleB, this.p5);
        !this.collider && Object(_utils__WEBPACK_IMPORTED_MODULE_5__["switchVelocity"])(particleB, particleA, this.p5);
...
/*!****************************************************!*\
  !*** ./src/components/sketchs/background/utils.ts ***!
  \****************************************************/
/*! exports provided: switchVelocity */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var switchVelocity = function switchVelocity(particleA, particleB, p5) {
  particleA.velocity = p5.createVector(particleA.velocity.x * -Math.random() * 20 - particleB.velocity.x, particleA.velocity.y * -Math.random() * 20 - particleB.velocity.y);
};

/***/ })

})
//# sourceMappingURL=index.js.6e383218c033b7093502.hot-update.js.map