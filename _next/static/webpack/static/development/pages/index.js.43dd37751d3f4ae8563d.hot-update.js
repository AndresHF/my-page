...
var Particle = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Particle, [{
    ...
    value: function update(mouseX, mouseY) {
      ...
      this.velocity.limit(this.collided ? 10 : 5);
      this.position.add(this.velocity);
      if (this.tail.length > 1) this.tail = this.tail.slice(0, -1);else this.tail = [this.position.copy()].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(this.tail));
    ...
    value: function draw() {
      ...
      for (var i = 0; i < this.tail.length; i++) {
        this.p5.ellipse(this.tail[i].x * 0.5, this.tail[i].y * 0.5, width - i, height - i);
      }
    }
  }]);
...
//# sourceMappingURL=index.js.43dd37751d3f4ae8563d.hot-update.js.map