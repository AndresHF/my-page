...
var switchVelocity = function switchVelocity(particleA, particleB) {
  particleA.velocity = _this.p5.createVector(particleA.velocity.x * -Math.random() * 10 - particleB.velocity.x, particleA.velocity.y * -Math.random() * 10 - particleB.velocity.y);
};
...
var ParticleSystem = /*#__PURE__*/function () {
  function ParticleSystem(p5, offset) {
    ...
    this.p5 = p5;
    this.collision = true;
    this.image = p5.loadImage("../../../pictures/meFace3-2.png");
    this.offset = offset;
  }
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ParticleSystem, [{
    ...
    value: function checkColision(particleA, particleB, mousePosition) {
      ...
      if (collided) {
        switchVelocity(particleA, particleB);
        switchVelocity(particleB, particleA); // particleA.velocity = this.p5.createVector(
        //   particleA.velocity.x * -Math.random() * 10 - particleB.velocity.x,
        //   particleA.velocity.y * -Math.random() * 10 - particleB.velocity.y
        // );
        // particleB.velocity = this.p5.createVector(
        //   particleB.velocity.x * -Math.random() * 10 - particleA.velocity.x,
        //   particleB.velocity.y * -Math.random() * 10 - particleA.velocity.y
        // );
      }
    }
  }, {
    ...
    value: function update() {
      ...
      this.particles.map(function (particle, i) {
        ...
        var otherParticles = [].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_this2.particles.slice(0, i)), Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_this2.particles.slice(i + 1, _this2.particles.length)));

        if (_this2.collider) {
          _this2.checkColision(particle, _this2.collider, {
            x: mouseX,
            y: mouseY
          });
        } else {
          if (_this2.collision) otherParticles.map(function (other) {
            return _this2.checkColision(particle, other);
          });
        }
      ...
      if (this.collider) {
        //console.log("COLIDER POS", mouseX, mouseY);
...
//# sourceMappingURL=index.js.2c54184df147e7607768.hot-update.js.map