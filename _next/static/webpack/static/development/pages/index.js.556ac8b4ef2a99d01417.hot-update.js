...
var glowSymbols = function glowSymbols(glowChunk, tail, index, p5) {
  if (index + glowChunk > 0) {
    for (var i = 0; i < glowChunk; i++) {
      tail[i].shouldGlow = true;
      tail[i].symbol = getRandomSymbol();
      tail[i].shadeOffset = getRandomNumber(255, 80);
    }
  }
};
...
//# sourceMappingURL=index.js.556ac8b4ef2a99d01417.hot-update.js.map