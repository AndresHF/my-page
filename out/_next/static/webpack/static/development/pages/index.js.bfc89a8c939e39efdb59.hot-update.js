...
var Particle = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Particle, [{
    ...
    value: function drawCollider(mouseX, mouseY, image) {
      ...
      this.p5.fill("white"); //this.p5.pointLight(255, 255, 255, mouseX, mouseY, 250);
      //this.p5.rotateX(millis / 1000);

      this.p5.rotateY(millis / 1000); //this.p5.rotateZ(millis / 1000);

      this.p5.texture(image);
      this.p5.stroke(0, 0, 0); //this.p5.sphere(40, 100, 100); //

      this.p5.ellipsoid(40);
    }
  }, {
    key: "draw",
    value: function draw() {
...
//# sourceMappingURL=index.js.bfc89a8c939e39efdb59.hot-update.js.map