      ...
      var _loop = function _loop(i) {
        ...
        if (changeSymbol) {
          setTimeout(function () {
            ...
            _this.tail[i].shadeOffset = getRandomNumber(255, 180);
          }, _this.tail.length * 1000 - i * _this.rainSpeed);
        }

        if (_this.tail[i].shouldGlow) {
          // i < 1 ||
          //if (i === 0) this.rainSpeed = getRandomNumber(80, 50);
          var brigthness = getRandomNumber(255, 200);
          p5.stroke(brigthness, 255, brigthness, 100); //, this.tail[i].shadeOffset
...
//# sourceMappingURL=index.js.8a597e346fdab048999b.hot-update.js.map