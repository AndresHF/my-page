...
var Symbol = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function initSymbol(p5, positionX) {
      this.position = p5.createVector(positionX, p5.height); //-Math.random() * 500);
    ...
    value: function update(p5) {
      ...
      var _loop = function _loop(i) {
        ...
        if (changeSymbol) {
          setTimeout(function () {
            glowSymbols(getRandomNumber(3, 1), _this.tail, i, p5); // this.tail[i].shouldGlow = true;

            _this.tail[i].symbol = getRandomSymbol(); //   this.tail[i].shadeOffset = getRandomNumber(255, 80);
          }, _this.tail.length * 100 - i * 80);
        }
...
//# sourceMappingURL=index.js.d78cf57d1468763e7e8d.hot-update.js.map