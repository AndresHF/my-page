...
var ParticleSystem = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ParticleSystem, [{
    ...
    key: "checkColision",
    value: function checkColision(particleA, particleB, collider) {
      var distance = particleA.position.dist(particleB.position) * (collider ? 2 : 10);
    ...
    value: function update() {
      ...
      this.particles.map(function (particle, i) {
        ...
        if (_this.collider) {
          _this.checkColision(particle, _this.collider, true);
        } else {
      ...
      if (this.collider) {
        console.log("COLIDER POS", this.p5.mouseX, this.p5.mouseY);
...
//# sourceMappingURL=index.js.7f9103cc21f9328a0560.hot-update.js.map