  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Particle, [{
    ...
    value: function update(mouseX, mouseY) {
      var _this$position = this.position,
          x = _this$position.x,
          y = _this$position.y;
      this.acceleration = this.p5.createVector(checkPos(x, mouseX, this.acceleration.x), // - window.innerWidth / 2
      checkPos(y, mouseY, this.acceleration.y) //  - window.innerHeight / 2
      );
    ...
    value: function drawCollider(mouseX, mouseY) {
      //this.p5.fill("red");
      this.p5.fill("white");
      this.p5.pointLight(255, 255, 255, this.p5.width / 2, this.p5.height / 2, 0);
      this.p5.rotateX(mouseX);
      this.p5.rotateY(mouseY);
...
//# sourceMappingURL=index.js.ae3e355a9d53083fceb8.hot-update.js.map