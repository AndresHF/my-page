...
var Symbol = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function update(p5) {
      ...
      var glow = getRandomNumber(this.tail.length - 1 / 2, 0);
      ...
      var _loop = function _loop(i) {
        ...
        if (_this.tail[i].shouldGlow) {
          // i < 1 ||
          p5.fill(80, 255, 80, _this.tail[i].shadeOffset * 3);
      ...
      for (var i = this.tail.length - 1; i >= glow; i--) {
        _loop(i);
      }
    }
  }, {
...
//# sourceMappingURL=index.js.8b35edecf24302d3737e.hot-update.js.map