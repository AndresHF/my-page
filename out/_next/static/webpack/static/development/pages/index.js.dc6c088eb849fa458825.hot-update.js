      ...
      var _loop = function _loop(i) {
        ...
        if (changeSymbol) {
          setTimeout(function () {
            ...
            _this.tail[i].changeOffset = Math.random() * 5;
          }, 6000 - i * _this.rainSpeed);
        }

        if (_this.tail[i].shouldGlow) {
          //const brigthness = getRandomNumber(120, 80);
          //p5.stroke(brigthness, 255, brigthness, this.tail[i].shadeOffset);
          p5.strokeWeight(2);
          p5.stroke(255, 80);
          p5.fill(255, 80);
...
//# sourceMappingURL=index.js.dc6c088eb849fa458825.hot-update.js.map