  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function update(p5) {
      ...
      var _loop = function _loop(i) {
        ...
        if (p5.frameCount % 2 == 0) _this.tail[i].shadeOffset -= 10;

        if (changeSymbol) {
          setTimeout(function () {
            _this.tail[i].shouldGlow = true;
            _this.tail[i].symbol = getRandomSymbol();
            _this.tail[i].shadeOffset = getRandomNumber(500, 0);
...
//# sourceMappingURL=index.js.f315fdf56c0038994d8a.hot-update.js.map