    ...
    value: function checkColision(particleA, particleB, mousePosition) {
      ...
      if (mousePosition) {
        var x = mousePosition.x,
            y = mousePosition.y;
        var mousePos = this.p5.createVector(this.offset.x - x, this.offset.y - y);
        distance = particleA.position.dist(mousePos);
        console.log("A<<<<", particleA.position, "<<<<COLIDERRR", mousePos);
      } else {
...
//# sourceMappingURL=index.js.1abd1984e29f3456070b.hot-update.js.map