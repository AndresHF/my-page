    ...
    value: function draw(p5) {
      ...
      if (this.tail) {
        for (var i = 0; i < this.tail.length; i++) {
          ...
          if (checkMouseHover(this.position.x, calculatedY, p5.mouseX, p5.mouseY) || this.tail[i].lastSymbol !== this.tail[i].symbol) {
            p5.fill(0, 200, 0);
          } else {
...
//# sourceMappingURL=index.js.acf0eb0a5cb150c81997.hot-update.js.map