...
var Symbol = /*#__PURE__*/function () {
  function Symbol(p5, positionX) {
    ...
    if (isHead) {
      this.velocity = p5.createVector(0, Math.random() * 3 + 3);
      this.tail = new Array(getRandomNumber(p5.width / 100) + 15);
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function update(p5) {
      ...
      var _loop = function _loop(i) {
        ...
        if (_this.tail[i].shouldGlow || i < 2) {
          p5.fill(150, 255, 150, alpha * 2);
...
//# sourceMappingURL=index.js.b684743348f2c281090d.hot-update.js.map