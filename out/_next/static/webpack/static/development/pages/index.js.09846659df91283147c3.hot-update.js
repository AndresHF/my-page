  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Particle, [{
    ...
    value: function update(mouseX, mouseY) {
      var _this$position = this.position,
          x = _this$position.x,
          y = _this$position.y;
      this.acceleration = this.p5.createVector(checkPos(x, mouseX - window.innerWidth / 2, this.acceleration.x), checkPos(y, mouseY - window.innerHeight / 2, this.acceleration.y));
...
//# sourceMappingURL=index.js.09846659df91283147c3.hot-update.js.map