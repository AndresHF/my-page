  ...
  function Symbol(p5) {
    ...
    if (isHead) {
      ...
      for (var i = 0; i < this.tail.length; i++) {
        this.tail[i] = new Symbol(p5, false); //const calculatedY = this.position.y - (Y_OFFSET * this.velocity.y / 2 * i)
      }
    }
  }
...
//# sourceMappingURL=index.js.de835a064cc551406316.hot-update.js.map