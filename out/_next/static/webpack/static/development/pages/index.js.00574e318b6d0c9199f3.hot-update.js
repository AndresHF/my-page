...
var Symbol = /*#__PURE__*/function () {
  function Symbol(p5, positionX) {
    ...
    if (isHead) {
      ...
      this.shadeOffset = Math.floor(Math.random() * 255);
      ...
      var _loop = function _loop(i) {
        ...
        if (changeSymbol) {
          setTimeout(function () {
            ...
            _this.tail[i].shadeOffset = Math.floor(Math.random() * 255);
          }, _this.tail.length * 500 - i * 50);
        }
...
//# sourceMappingURL=index.js.00574e318b6d0c9199f3.hot-update.js.map