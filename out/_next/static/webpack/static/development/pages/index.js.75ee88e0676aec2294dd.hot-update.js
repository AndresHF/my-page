...
var getRandomSymbol = function getRandomSymbol() {
  return String.fromCharCode(0x30A0 + Math.round(Math.random() * 200));
};
...
var Symbol = /*#__PURE__*/function () {
  function Symbol(p5, positionX) {
    ...
    if (isHead) {
      this.tail = new Array(getRandomNumber(p5.width / 20));
    ...
    value: function draw(p5) {
      ...
      if (this.tail) {
        for (var i = 0; i < this.tail.length; i++) {
          ...
          var alpha = 255 - 3 * i; //const alphaOffset = this.tail[i].lastSymbol !== this.tail[i].symbol ? alpha + 100: alpha;

          if (i < 2) {
            p5.fill(120, 255, 120, alpha * 2);
          } else {
...
//# sourceMappingURL=index.js.75ee88e0676aec2294dd.hot-update.js.map