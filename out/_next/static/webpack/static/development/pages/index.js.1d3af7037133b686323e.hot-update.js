...
var Particle = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Particle, [{
    ...
    key: "drawCollider",
    value: function drawCollider(mouseX, mouseY) {
      this.p5.fill("red"); //this.p5.sphere(mouseX, mouseY, 40);

      for (var i = 0; i < 500; i += 100) {
        this.p5.push();
        this.p5.fill(i * 0.1, 100, 100); //line

        this.p5.translate(0, 100, 0);
        this.p5.line(-100, 0, i, 100, 0, i); //triangles

        this.p5.translate(0, 100, 0);
        this.p5.triangle(0, this.p5.sin(i + this.p5.frameCount * 0.1) * 10, i, 60, 60, i); //quad

        this.p5.translate(0, 200, 0);
        this.p5.quad(-100, i, 0, 100, i, 0, -100, 100, i, 100, 100, i);
        this.p5.pop();
      }
    }
  }, {
...
//# sourceMappingURL=index.js.1d3af7037133b686323e.hot-update.js.map