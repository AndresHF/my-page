  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ParticleSystem, [{
    ...
    value: function checkColision(particleA, particleB, mousePosition) {
      ...
      if (collided) {
        ...
        particleB.velocity = this.p5.createVector(particleB.velocity.x * -Math.random() * 10 - particleA.velocity.x, particleB.velocity.y * -Math.random() * 10 - particleA.velocity.y);
      }
    }
  }, {
    key: "update",
...
//# sourceMappingURL=index.js.6edf0b038ab25f4a4c92.hot-update.js.map