...
var ParticleSystem = /*#__PURE__*/function () {
  function ParticleSystem(p5) {
    ...
    this.p5 = p5;
    this.collision = true;
    this.image = p5.loadImage("../../../public/images/react.png");
  }
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ParticleSystem, [{
    ...
    value: function update() {
      ...
      if (this.collider) {
        this.collider.drawCollider(this.p5.mouseX, this.p5.mouseY);
      }
    }
  }]);
...
//# sourceMappingURL=index.js.756c2d0aad509723827d.hot-update.js.map