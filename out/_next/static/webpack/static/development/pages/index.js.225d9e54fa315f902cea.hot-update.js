...
var checkPos = function checkPos(pos, mouse, acceleration, collided) {
  var collisionMultiplier = collided ? 100 : 1;
  if (pos <= mouse) return acceleration + ACC_RATE * collisionMultiplier;
  if (pos >= mouse) return acceleration - ACC_RATE * collisionMultiplier;
  return 0;
};
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Particle, [{
    ...
    value: function update(mouseX, mouseY) {
      var _this$position = this.position,
          x = _this$position.x,
          y = _this$position.y;
      this.acceleration = this.p5.createVector(checkPos(x, mouseX - this.offset.x, this.acceleration.x, this.collided), // - window.innerWidth / 2
      checkPos(y, mouseY - this.offset.y, this.acceleration.y, this.collided) //  - window.innerHeight / 2
      );
      this.acceleration.limit(this.collided ? 20 : this.accLimit);
      this.acceleration.setMag(this.collided ? -2 : 0.08);
      this.velocity.add(this.acceleration);
      this.velocity.limit(this.collided ? 10 : 3);
    ...
    value: function drawCollider(mouseX, mouseY, image) {
      ...
      this.p5.fill("white");
      this.p5.pointLight(255, 255, 255, 0, 0, 10000); //this.p5.rotateX(millis / 1000);
      ...
      this.p5.pop(); //this.p5.ellipsoid(75);
    }
  }, {
    key: "draw",
    value: function draw() {
...
//# sourceMappingURL=index.js.225d9e54fa315f902cea.hot-update.js.map