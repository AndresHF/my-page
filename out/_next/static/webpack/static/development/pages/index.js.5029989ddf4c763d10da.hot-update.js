  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function update(p5) {
      ...
      var _loop = function _loop(i) {
        ...
        if (p5.frameCount % 2 == 0) _this.tail[i].shadeOffset -= getRandomNumber(10, 1);
        ...
        if (changeSymbol) {
          setTimeout(function () {
            ...
            _this.tail[i].changeOffset = Math.random() * 10;
          }, 6000 - i * _this.rainSpeed);
        }

        if (_this.tail[i].shouldGlow) {
          var brigthness = getRandomNumber(120, 80); //p5.stroke(brigthness, 255, brigthness, this.tail[i].shadeOffset);
          ...
          p5.strokeWeight(0.2);
          p5.stroke(80, 255, 80, _this.tail[i].shadeOffset); // p5.noStroke();
...
//# sourceMappingURL=index.js.5029989ddf4c763d10da.hot-update.js.map