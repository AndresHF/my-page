...
var Symbol = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Symbol, [{
    ...
    value: function initSymbol(p5, positionX) {
      ...
      this.rainSpeed = getRandomNumber(0.25, 0.7);
    }
  }, {
    key: "update",
    value: function update(p5) {
      ...
      var _loop = function _loop(i) {
        ...
        if (changeSymbol) {
          ...
          }, 2500 - i * _this.rainSpeed);
        }

        if (_this.tail[i].shouldGlow) {
          // i < 1 ||
          //if (i === 0) this.rainSpeed = getRandomNumber(80, 50);
          var brigthness = getRandomNumber(255, 180);
          p5.stroke(brigthness, 255, brigthness, 150); //, this.tail[i].shadeOffset
...
//# sourceMappingURL=index.js.6266765d31135eb6c1db.hot-update.js.map